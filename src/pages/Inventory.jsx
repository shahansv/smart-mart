...
import { addProduct, deleteProduct, displayProducts, editProduct } from "../services/allApi";
        ...
        <div className="py-7 flex flex-col items-center bg-white rounded-2xl border-base-100 shadow homeCard h-fit p-3 col-span-1">
          ...
          <fieldset className="fieldset w-full px-3">
            ...
            <datalist id="browsers">
              ...
              <option value="SteelSeries"></option>
                      ...
                      <tr key={index}>
                        <td>
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="font-bold">{eachProduct.productName}</div>
                              <div className="text-sm opacity-50">{eachProduct.productBrand}</div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="text-center">
                          <button className="btn btn-soft btn-warning m-2 hover:text-amber-50 hover:bg-amber-300 border-0 rounded-2xl"
                            onClick={() => onCLickEditBtn(eachProduct)}>
                            Edit
                          </button>
                          <button className="btn btn-soft btn-error m-2 hover:text-red-50 hover:bg-red-400 border-0 rounded-2xl" onClick={() => deleteThisProduct(eachProduct.id)}>
                            Delete
                          </button>
                        </td>
                      </tr>
